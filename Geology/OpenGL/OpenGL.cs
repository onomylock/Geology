...
namespace Geology.OpenGL
{
    public partial class OpenGL
    {
        ...
        public const string LIBRARY_INITDRAWTEXTOPENGL = "DllInitAndDrawText.dll";

        [DllImport(LIBRARY_INITDRAWTEXTOPENGL, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern int InitOpenGL(int hdc);

        [DllImport(LIBRARY_INITDRAWTEXTOPENGL, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern void PrintText(int fontListBase, double x, double y, double z, [MarshalAs(UnmanagedType.LPWStr)]string str);

        [DllImport(LIBRARY_INITDRAWTEXTOPENGL, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern int PrepareFontForText(int hdc, [MarshalAs(UnmanagedType.LPWStr)]string fonts, int fontSize, int orientation, ref IntPtr UseFont);

        [DllImport(LIBRARY_INITDRAWTEXTOPENGL, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern int GetStringWidth(int hdc, [MarshalAs(UnmanagedType.LPWStr)]string str, IntPtr UseFont);

        [DllImport(LIBRARY_INITDRAWTEXTOPENGL, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern int GetStringHeight(int hdc, [MarshalAs(UnmanagedType.LPWStr)]string str, IntPtr UseFont);

        [DllImport(LIBRARY_INITDRAWTEXTOPENGL, CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern void ClearFontText(int fontListBase, IntPtr UseFont);
        ...
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.Begin callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.BeginData callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.Combine callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.CombineData callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.EdgeFlag callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.EdgeFlagData callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.End callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.EndData callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.Error callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.ErrorData callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.Vertex callback);
        //		[DllImport(LIBRARY_GLU, SetLastError = true)] public static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.VertexData callback);
        [DllImport(LIBRARY_GLU, SetLastError = true)]
