...
namespace Geology.Objects.GeoModel
{
    ...
    public static class GeoModelSettings
    {
    ...
    public class GeoModelLayer
    {
        double z0 = 0, z1 = 0;
        int nnx, nny, nnz, nnxy, nn;
        int nex, ney, nez, nexy, ne;
        public List<GeoModelObject> objects = new List<GeoModelObject>();
        ...
        private void Build1DMeshes(double x0, double x1, double y0, double y1, double z0, double z1)
        {
            ...
            Refine1DMesh(coords, GeoModelSettings.stepX);
            ...
            Refine1DMesh(coords, GeoModelSettings.stepY);
    ...
    public class GeoModelObject
    {
        ...
        public GeoModelObject()
        {

        }
    }
    public class GeoModel : INotifyPropertyChanged, Utilities.IViewportObjectsDrawable, Utilities.IViewportMouseMoveReaction, Utilities.IViewportObjectsSelectable, Utilities.IViewportObjectsClickable
    {
        private class HighlightedObjectInfo
        {
            ...
            private void DrawHighlightedFace()
            {
                if (Face != "")
                {
                    ...
                    var ix = GeoModelSettings.FacePropertiesX[Face];
                    var iy = GeoModelSettings.FacePropertiesY[Face];
                    var iz = GeoModelSettings.FacePropertiesZ[Face];
        ...
        private ObservableCollection<Objects.SaturationModel.SaturationVolumeStack> stacks = new ObservableCollection<SaturationModel.SaturationVolumeStack>();
